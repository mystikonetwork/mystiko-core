...
export interface MystikoV2WithTBridgeInterface extends utils.Interface {
  contractName: 'MystikoV2WithTBridge';
  functions: {
...
export interface MystikoV2WithTBridge extends BaseContract {
  contractName: 'MystikoV2WithTBridge';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MystikoV2WithTBridgeInterface;
