...
import type { MystikoBridge, MystikoBridgeInterface } from '../MystikoBridge';
...
export class MystikoBridge__factory {
  static readonly abi = _abi;
  static createInterface(): MystikoBridgeInterface {
    return new utils.Interface(_abi) as MystikoBridgeInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): MystikoBridge {
    return new Contract(address, _abi, signerOrProvider) as MystikoBridge;
  }
}
